...
<head>
    ...
    <title>Pants Collection - Dwarkesh Menswear</title>
...
<body>
                ...
                <div class="row justify-content-center align-items-center" style="min-height: 60vh;">
                    <div class="col-lg-8 text-center">
                        <h1 class="hero-title animate-text">
                            <span class="text-gold">Pants</span> Collection
                        </h1>
                        <p class="hero-subtitle">Discover our comfortable and stylish pants collection</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-5">
        <div class="container">
            <div class="row g-4" id="pantsContainer">
        <?php
           $result = mysqli_query($conn, "SELECT * FROM products WHERE category='pant'");
